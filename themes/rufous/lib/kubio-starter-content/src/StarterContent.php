						...
						wp_json_encode(
							array(
								...
								'texts'        => array(
									...
									'message'              => Translations::get( 'customize_preview_overlay_message', 'rufous' ),
									'install'              => Translations::get( 'installing', 'rufous' ),
									'activate'             => Translations::get( 'activating', 'rufous' ),
								),
